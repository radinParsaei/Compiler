  ...
  static void error(byte errorCode, String... args) {
    switch (errorCode) {
      case ErrorCodes.ERROR_VARIABLE_DOES_NOT_EXISTS:
        Compiler.syntaxError("Variable " + args[0] + " does not exist");
        break;
      case ErrorCodes.ERROR_FUNCTION_DOES_NOT_EXISTS:
        Compiler.syntaxError("Function " + args[0].split(":")[0] + " does not exist");
        break;
      ...
      case ErrorCodes.ERROR_ARGS_NOT_MATCH:
        Compiler.syntaxError("Arguments do not match for " + args[0].split(":")[0]);
        break;
      ...
      case ErrorCodes.ERROR_CLASS_REDECLARATION:
        Compiler.syntaxError("Class " + args[0] + " already exists");
        break;
    }
